...
async function createCompleteSchema() {
  console.log('🔧 완전한 상담 관리 시스템 스키마 생성 가이드...');
  ...
  try {
    ...
    if (!customersError && !consultationsError) {
      console.log('✅ customers와 consultations 테이블이 모두 존재합니다.');
      console.log('🎉 스키마가 이미 완성되어 있습니다. 마이그레이션을 진행할 수 있습니다.');
      return;
    }
...
-- ========================================
    ...
    console.log('');
    console.log('🔗 Supabase 대시보드: https://supabase.com/dashboard/project/' + supabaseUrl.split('//')[1].split('.')[0]);
